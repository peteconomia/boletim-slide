...
\begin{frame}
	...
	\begin{figure}%
		\centering
		\subfloat[\centering Expectativas de Crescimento do PIB para 2020]{{\includegraphics[width=.45\textwidth]{figs/PIB.pdf} }}%
		%\qquad
...
\begin{frame}
	...
	\begin{figure}%
		\centering
		\subfloat[\centering Resultado Trimestral do PIB pelo Lado da Demanda]{{\includegraphics[width=.45\textwidth]{figs/pib_demanda.pdf} }}%
		\qquad
		\subfloat[\centering Resultado Trimestral do PIB pelo Lado da Oferta]{{\includegraphics[width=.45\textwidth]{figs/pib_oferta.pdf} }}%
	\end{figure}
\end{frame}
\begin{frame}
	\frametitle{Panorama Econômico}
...
\begin{frame}
    ...
    \begin{figure}%
        \centering
        \subfloat[\centering Despesa total com pessoal em relação à RCL]{{\includegraphics[width=.45\textwidth]{figs/desp_pessoal_rcl-1.pdf} }}%
        \qquad
        \subfloat[\centering Dívida Consolidada Líquida em relação à RCL]{{\includegraphics[width=.45\textwidth]{figs/divida_rcl-1.pdf} }}%
    \end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}%
		\centering
		\subfloat[\centering Taxa de Pobreza - Linha de US\$5,50 PPC]{{\includegraphics[width=.45\textwidth]{figs/taxa_pobreza.pdf} }}%
		\qquad
		\subfloat[\centering Taxa de Extrema Pobreza - Linha de US\$1,90 PPC]{{\includegraphics[width=.45\textwidth]{figs/taxa_expobreza.pdf} }}%
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}%
		\centering
		\subfloat[\centering Índice de Gini]{{\includegraphics[width=.45\textwidth]{figs/gini.pdf} }}%
	\end{figure}	
\end{frame}
